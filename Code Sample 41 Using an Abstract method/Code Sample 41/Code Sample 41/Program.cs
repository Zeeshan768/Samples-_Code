...
namespace Code_Sample_41
    ...
    public class BabyAccount :Account
        ...
        public static void Main()
            ...
            accounts[0].PayInFunds(5);
            Console.WriteLine("Balance: " + accounts[0].RudeLetterString());

            accounts[1] = new BabyAccount();
            Console.WriteLine("Balance: " + accounts[1].RudeLetterString());
            Console.ReadKey();
            }
        }
    }