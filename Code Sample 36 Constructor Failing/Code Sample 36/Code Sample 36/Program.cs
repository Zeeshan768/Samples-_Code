...
namespace Code_Sample_36
    ...
    class Account
        ...
        const decimal MIN_BALANCE = -100000000;
        ...
        public Account(string inName,string inAddress,decimal inBalance)
            ...
            if(errorMessage != "")
                {
                throw new Exception("Accouunt construction failed " + errorMessage);
                }
            }
    ...
    class Program
        ...
        public static void Main()
            ...
            Accounts[0] = new Account("Rob","",100000);
